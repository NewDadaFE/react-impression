  ...
  createClass(Alert, [
    {
      ...
      value: function render() {
        var _props = this.props,
          ...
          others = objectWithoutProperties(_props, [
            'type',
            'btnText',
            'onClick',
            'className',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('i', {
                className: classnames('fa', iconTypeClass),
              })
            ),
...
var Attention = (function (_PureComponent) {
  ...
  function Attention(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Attention.__proto__ || Object.getPrototypeOf(Attention)).call(
        this,
        props,
        context
      )
...
var Badge = (function (_PureComponent) {
  ...
  function Badge() {
    ...
    return possibleConstructorReturn(
      this,
      (Badge.__proto__ || Object.getPrototypeOf(Badge)).apply(this, arguments)
    )
  }
...
var Breadcrumb = function Breadcrumb(_ref) {
  var separator = _ref.separator,
    children = _ref.children,
    className = _ref.className,
    others = objectWithoutProperties(_ref, [
      'separator',
      'children',
      'className',
    ])
...
var ButtonGroup = (function (_PureComponent) {
  ...
  function ButtonGroup(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (ButtonGroup.__proto__ || Object.getPrototypeOf(ButtonGroup)).call(
        this,
        props,
        context
      )
...
var Calendar = (function (_Component) {
  ...
  function Calendar(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call(
        this,
        props,
        context
      )
  ...
  createClass(Calendar, [
      ...
      value: function getSortWeekdays() {
        ...
        return firstDayOfWeek === 0
          ...
          : [].concat(
            ...
            toConsumableArray(weekdays.slice(0, firstDayOfWeek))
          )
      },
      /**
       * 前一个月.
    ...
    },
    {
      ...
      value: function getDate() {
        ...
        // 上个月天数
        var firstDay = moment(currentMoment)
            .date(1)
            .day(),
        ...
        // 下个月天数
        var lastDay = moment(currentMoment)
            .date(daysLength)
            .day(),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(Icon, { type: 'angle-left' })
                    ),
                    React.createElement(
                      Button,
                      { onClick: this.nextMonthHandle },
                      React.createElement(Icon, { type: 'angle-right' })
                    )
                  )
                )
            ),
...
var Checkbox = (function (_PureComponent) {
  ...
  function Checkbox() {
    ...
    return possibleConstructorReturn(
      this,
      (Checkbox.__proto__ || Object.getPrototypeOf(Checkbox)).apply(
        this,
        arguments
      )
    )
...
var CheckboxGroup = (function (_PureComponent) {
  ...
  function CheckboxGroup(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (CheckboxGroup.__proto__ || Object.getPrototypeOf(CheckboxGroup)).call(
        this,
        props,
        context
      )
    ...
    _this.onChangeHandle = function (event, value) {
      ...
      if (_this.isPuppet) {
        var propsValue = _this.props.value,
          originValue = checked
            ? [].concat(toConsumableArray(propsValue), [value])
            : [].concat(
              toConsumableArray(
                propsValue.filter(function (item) {
                  return item !== value
                })
              )
            )
        ...
        var _originValue = checked
          ? [].concat(toConsumableArray(_this.state.value), [value])
          : [].concat(
            toConsumableArray(
              _this.state.value.filter(function (item) {
                return item !== value
              })
            )
          )
      ...
      value: function render() {
        ...
        children = React.Children.map(children, function (child, index) {
          ...
          return React.cloneElement(child, {
            ...
            checked: _this2.isPuppet
              ? _this2.props.value.indexOf(value) !== -1
              : _this2.state.value.indexOf(value) !== -1,
          })
        })
...
var CollapseTitle = function CollapseTitle(_ref) {
  ...
  return React.createElement(
    'div',
    _extends({ onClick: onClick }, others, {
      className: classnames('collapse-title', className),
    }),
    children,
    React.createElement('i', {
      className: 'fa fa-angle-right collapse-title-addon',
    })
  )
}
  ...
  function Confirm() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref = Confirm.__proto__ || Object.getPrototypeOf(Confirm)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      _this)),
      (_this.getAddonByType = function (type) {
        switch (type) {
          case 'info':
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('div', { className: 'confirm-body' }, children),
            React.createElement(
              'div',
  ...
  createClass(DatePicker, [
      ...
      value: function getDate(currentMoment) {
        ...
        for (var _i = 0; _i <= prevMonthMax - 1; _i++) {
          ...
          days.unshift({
            ...
            isToday: _dayMoment.isSame(today),
            disable:
              (minDate && _dayMoment.isBefore(minDate)) ||
              (maxDate && _dayMoment.isAfter(maxDate)),
          })
        }
        // 下个月天数
        var lastDay = moment(currentMoment)
        ...
        for (var _i2 = 1; _i2 < nextMonthMax; _i2++) {
          ...
          days.push({
            ...
            isToday: _dayMoment2.isSame(today),
            disable:
              (minDate && _dayMoment2.isBefore(minDate)) ||
              (maxDate && _dayMoment2.isAfter(maxDate)),
          })
        }
    ...
    },
    {
      ...
      value: function getYears(currentMoment) {
        ...
        for (
          var i = currentYear - yearScope;
          i <= currentYear + yearScope;
          i++
        ) {
          years.push(i)
        }
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('i', {
              className:
                'fa datepicker-header-btn fa-angle-left datepicker-month-btn',
              onClick: this.prevMonthHandle,
            }),
            React.createElement(
              'div',
            ...
            React.createElement('i', {
              className:
                'fa datepicker-header-btn fa-angle-right datepicker-month-btn',
              onClick: this.nextMonthHandle,
            }),
            React.createElement('i', {
            ...
            React.createElement(
              ...
              React.createElement(
                'a',
                {
                  ...
                  onClick: this.selectTodayHandle,
                },
                todayText
              )
            )
...
var _initialiseProps$1 = function _initialiseProps() {
  ...
  this.resetMonthPanelScroll = function () {
    ...
    _this3._yeargroupScrollTop = _yeargroup.scrollTop =
      _this3._activeYear.offsetTop - _yeargroup.offsetTop - yearHeight * 2
    _monthgroup.scrollTop =
      _this3._activeMonth.offsetTop - _monthgroup.offsetTop - monthHeight * 2
...
var DropdownMenu = (function (_PureComponent) {
  ...
  function DropdownMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (DropdownMenu.__proto__ || Object.getPrototypeOf(DropdownMenu)).apply(
        this,
        arguments
      )
    )
  ...
  createClass(DropdownMenu, [
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement('div', { className: 'dropdown-gap' }),
          React.createElement(
            'ul',
            {
              className: classnames(
  ...
  function DropdownMenuItem() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref =
          DropdownMenuItem.__proto__ ||
          Object.getPrototypeOf(DropdownMenuItem)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      _this)),
      (_this.onClickHandle = function () {
...
var init = function init() {
  ...
  document.body.onclick = function (event) {
    ...
    document.body.popLayers.forEach(function (component) {
      var componentDom = findDOMNode(component)
...
var FlexItem = (function (_PureComponent) {
  ...
  function FlexItem() {
    ...
    return possibleConstructorReturn(
      this,
      (FlexItem.__proto__ || Object.getPrototypeOf(FlexItem)).apply(
        this,
        arguments
      )
    )
...
var Flex = (function (_PureComponent) {
  ...
  function Flex() {
    ...
    return possibleConstructorReturn(
      this,
      (Flex.__proto__ || Object.getPrototypeOf(Flex)).apply(this, arguments)
    )
  }
...
var FormGroup = function FormGroup(_ref) {
  ...
  return React.createElement(
    'div',
    _extends({}, others, {
      className: classnames('form-group', colClass, className),
    }),
    children
  )
}
...
var FormControl = (function (_PureComponent) {
  ...
  function FormControl() {
    ...
    return possibleConstructorReturn(
      this,
      (FormControl.__proto__ || Object.getPrototypeOf(FormControl)).apply(
        this,
        arguments
      )
    )
...
var Form = (function (_PureComponent) {
  ...
  function Form() {
    ...
    return possibleConstructorReturn(
      this,
      (Form.__proto__ || Object.getPrototypeOf(Form)).apply(this, arguments)
    )
  }
  ...
  createClass(Image, [
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          'img',
          _extends({}, others, { className: classnames(classes, className) })
        )
      },
      // 默认props
    },
...
var InlineSelect = (function (_PureComponent) {
  ...
  function InlineSelect(props) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (InlineSelect.__proto__ || Object.getPrototypeOf(InlineSelect)).call(
        this,
        props
      )
    )
    ...
    },
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          'div',
          _extends({}, others, {
            className: classnames('inline-select', className),
          }),
          children
        )
      },
...
var Upload = (function (_PureComponent) {
  ...
  function Upload(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Upload.__proto__ || Object.getPrototypeOf(Upload)).call(
        this,
        props,
        context
      )
        ...
        if (preview) {
          ...
          return React.createElement(
            ...
            children ||
              React.createElement(Icon, {
                type: 'camera',
                className: 'upload-preview-addon',
              }),
            React.createElement(
              'span',
            ...
            (previewImageUrl || src) &&
              React.createElement(
                ...
                React.createElement('img', { src: previewImageUrl || src })
              )
          )
        }
...
var InputGroupInput = (function (_PureComponent) {
  ...
  function InputGroupInput() {
    ...
    return possibleConstructorReturn(
      this,
      (
        InputGroupInput.__proto__ || Object.getPrototypeOf(InputGroupInput)
...
var InputGroupButton = (function (_PureComponent) {
  ...
  function InputGroupButton() {
    ...
    return possibleConstructorReturn(
      this,
      (
        InputGroupButton.__proto__ || Object.getPrototypeOf(InputGroupButton)
      ).apply(this, arguments)
    )
  }
...
var ListGroupItem = (function (_PureComponent) {
  ...
  function ListGroupItem(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (ListGroupItem.__proto__ || Object.getPrototypeOf(ListGroupItem)).call(
        this,
        props,
        context
      )
...
var LoadingAddon = (function (_PureComponent) {
  ...
  function LoadingAddon(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (LoadingAddon.__proto__ || Object.getPrototypeOf(LoadingAddon)).call(
        this,
        props,
        context
      )
    ...
    },
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          'div',
          _extends({}, others, {
            className: classnames('loading', typeClass, className),
          }),
          loadingAddon,
          React.createElement(
            'div',
...
var Loading = (function (_PureComponent) {
  ...
  function Loading(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Loading.__proto__ || Object.getPrototypeOf(Loading)).call(
        this,
        props,
        context
      )
  ...
  createClass(Loading, [
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(LoadingAddon, {
            type: type,
            show: show,
...
var Message = (function (_Component) {
  ...
  function Message(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Message.__proto__ || Object.getPrototypeOf(Message)).call(
        this,
        props,
        context
      )
            ...
            show &&
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement('i', { className: classnames(iconClass) })
                ),
                React.createElement(
                  'div',
...
var showMessage = function showMessage(theme, message) {
  var duration =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2000
...
var MessageItem = (function (_PureComponent) {
  ...
  function MessageItem() {
    ...
    return possibleConstructorReturn(
      this,
      (MessageItem.__proto__ || Object.getPrototypeOf(MessageItem)).apply(
        this,
        arguments
      )
    )
...
var NavItem = (function (_PureComponent) {
  ...
  function NavItem() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref = NavItem.__proto__ || Object.getPrototypeOf(NavItem)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
...
var Nav = (function (_PureComponent) {
  ...
  function Nav(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Nav.__proto__ || Object.getPrototypeOf(Nav)).call(this, props, context)
    )
...
var Navbar = function Navbar(_ref) {
  ...
  return React.createElement(
    'nav',
    _extends({}, others, {
      className: classnames('navbar', themeClass, className),
    }),
    children
  )
}
...
var Notice = (function (_PureComponent) {
  ...
  function Notice() {
    ...
    return possibleConstructorReturn(
      this,
      (Notice.__proto__ || Object.getPrototypeOf(Notice)).apply(this, arguments)
    )
  }
    ...
    },
    {
      ...
      value: function addNotice(_ref, theme) {
        var title = _ref.title,
          ...
          closeable =
            _ref$closeable === undefined ? this.props.closeable : _ref$closeable
  ...
  function Pagination() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref =
          Pagination.__proto__ || Object.getPrototypeOf(Pagination)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      _this)),
      (_this.prevPageHandle = function () {
        var _this$props = _this.props,
          onSelect = _this$props.onSelect,
      ...
      (_this.nextPageHandle = function () {
        var _this$props2 = _this.props,
          ...
          totalPage =
            _this$props2$totalPag === undefined ? 1 : _this$props2$totalPag
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props2 = this.props,
          ...
          others = objectWithoutProperties(_props2, [
            'totalPage',
            'className',
            'ellipsis',
            'activePage',
...
var Popover = (function (_PureComponent) {
  ...
  function Popover() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref = Popover.__proto__ || Object.getPrototypeOf(Popover)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      value: function createPopover(targetRect) {
        ...
        switch (position) {
          case 'top':
            ...
            popoverNode.style.left =
              targetRect.left -
              (popoverRect.width - targetRect.width) / 2 +
              'px'
            break
          case 'left':
            popoverNode.style.left = targetRect.left - popoverRect.width + 'px'
            popoverNode.style.top =
              targetRect.top +
...
var Radio = (function (_PureComponent) {
  ...
  function Radio() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref = Radio.__proto__ || Object.getPrototypeOf(Radio)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
    ...
    },
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement('span', { className: 'radio-label' }, children)
        )
      },
    },
  ])
...
var RadioGroup = (function (_PureComponent) {
  ...
  function RadioGroup(props) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (RadioGroup.__proto__ || Object.getPrototypeOf(RadioGroup)).call(
        this,
        props
      )
    )
      ...
      value: function render() {
        ...
        children = React.Children.map(children, function (child, index) {
          ...
          var _child$props = child.props,
            ...
            options = {
              name:
                name || 'radio_' + _this2._reactInternalInstance._mountOrder,
              key: index,
              onChange: _this2.onChangeHandle,
              disabled: disabled || _this2.props.disabled,
            }
...
var Select = (function (_PureComponent) {
  ...
  function Select(props, context) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Select.__proto__ || Object.getPrototypeOf(Select)).call(
        this,
        props,
        context
      )
      ...
      value: function render() {
        ...
        children = React.Children.map(children, function (child, index) {
          ...
          value === originValue &&
            !disabled &&
            _this2.refs.main &&
            (_this2.refs.main.value = children)
          return React.cloneElement(child, {
            key: index,
            active: value === originValue,
            onClick: function onClick() {
              return (
                !disabled && _this2.selectOptionHandle(value, children, index)
              )
            },
          })
        })
        ...
        return React.createElement(
          ...
          React.createElement('ul', { className: 'select-options' }, children)
        )
      },
    },
  ])
...
var SidebarFooter = (function (_PureComponent) {
  ...
  function SidebarFooter() {
    ...
    return possibleConstructorReturn(
      this,
      (SidebarFooter.__proto__ || Object.getPrototypeOf(SidebarFooter)).apply(
        this,
        arguments
      )
    )
...
function Instance(element) {
  ...
  i.scrollbarXTop = i.isScrollbarXUsingBottom
    ? null
    : helper.toInt(dom.css(i.scrollbarXRail, 'top'))
  i.railBorderXWidth =
    helper.toInt(dom.css(i.scrollbarXRail, 'borderLeftWidth')) +
    helper.toInt(dom.css(i.scrollbarXRail, 'borderRightWidth'))
  // Set rail to display:block to calculate margins
  dom.css(i.scrollbarXRail, 'display', 'block')
  i.railXMarginWidth =
    helper.toInt(dom.css(i.scrollbarXRail, 'marginLeft')) +
    helper.toInt(dom.css(i.scrollbarXRail, 'marginRight'))
  ...
  i.scrollbarYLeft = i.isScrollbarYUsingRight
    ? null
    : helper.toInt(dom.css(i.scrollbarYRail, 'left'))
  i.scrollbarYOuterWidth = i.isRtl ? helper.outerWidth(i.scrollbarY) : null
  i.railBorderYWidth =
    helper.toInt(dom.css(i.scrollbarYRail, 'borderTopWidth')) +
    helper.toInt(dom.css(i.scrollbarYRail, 'borderBottomWidth'))
  dom.css(i.scrollbarYRail, 'display', 'block')
  i.railYMarginHeight =
    helper.toInt(dom.css(i.scrollbarYRail, 'marginTop')) +
    helper.toInt(dom.css(i.scrollbarYRail, 'marginBottom'))
...
var updateGeometry = function (element) {
  ...
  if (
    ...
    i.scrollbarXWidth = getThumbSize(
      i,
      helper.toInt((i.railXWidth * i.containerWidth) / i.contentWidth)
    )
    i.scrollbarXLeft = helper.toInt(
      ((i.negativeScrollAdjustment + element.scrollLeft) *
  ...
  if (
    ...
    i.scrollbarYHeight = getThumbSize(
      i,
      helper.toInt((i.railYHeight * i.containerHeight) / i.contentHeight)
    )
    i.scrollbarYTop = helper.toInt(
...
var touch = function (element) {
  ...
  bindTouchHandler(
    element,
    i,
    helper.env.supportsTouch,
    helper.env.supportsIePointer
  )
}
...
var SidebarBody = (function (_PureComponent) {
  ...
  function SidebarBody() {
    ...
    return possibleConstructorReturn(
      this,
      (SidebarBody.__proto__ || Object.getPrototypeOf(SidebarBody)).apply(
        this,
        arguments
      )
    )
...
var Split = (function (_PureComponent) {
  ...
  function Split() {
    ...
    return possibleConstructorReturn(
      this,
      (Split.__proto__ || Object.getPrototypeOf(Split)).apply(this, arguments)
    )
  }
    ...
    },
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement('div', { className: 'switch-addon' })
        )
      },
    },
  ])
...
var Tag = (function (_PureComponent) {
  ...
  function Tag() {
    ...
    return possibleConstructorReturn(
      this,
      (Tag.__proto__ || Object.getPrototypeOf(Tag)).apply(this, arguments)
    )
  }
...
var TimelineItem = function TimelineItem(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement('div', { className: 'timeline-item-line' }),
    React.createElement(
      'div',
      { className: 'timeline-item-addon' },
      dot || React.createElement('i', { className: 'fa fa-circle-o' })
    ),
    React.createElement('div', { className: 'timeline-item-body' }, children)
  )
}
...
var Timeline = function Timeline(_ref) {
  ...
  return React.createElement(
    'ul',
    _extends({}, others, {
      className: classnames('timeline', sizeClass, className),
    }),
    children
  )
}
...
var Tooltip = (function (_PureComponent) {
  ...
  function Tooltip() {
    ...
    return (
      (_ret = ((_temp = ((_this = possibleConstructorReturn(
        this,
        (_ref = Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
        ...
        switch (position) {
          case 'top':
            ...
            tooltipNode.style.left =
              targetRect.left -
              (tooltipRect.width - targetRect.width) / 2 +
              'px'
            break
          case 'left':
