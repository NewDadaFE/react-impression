      ...
      switch (type) {
        ...
        case 'month':
          return React.createElement(
            ...
            clearable && showClear && React.createElement('i', {
              className: 'fa fa-times input-addon',
              onClick: this.clearInputHandle
            }),
            (!showClear || !clearable) && React.createElement('i', {
...
export { Alert, Attention, Badge, Breadcrumb, Button, ButtonGroup, ButtonToolbar, Calendar, Card, Checkbox, CheckboxGroup, Col, Collapse, Confirm, Container, Content, DatePicker, Dropdown, Flex, Form, Icon, Image, InlineSelect, Input, InputGroup, ListGroup, Loading, Message, MessageItem, Modal, Nav, Navbar, Notice, Notification, Pagination, Popover, Progress, Radio, RadioGroup, Row, Select, Sidebar, Split, Switch, Tag, Timeline, Tooltip, Upload };
