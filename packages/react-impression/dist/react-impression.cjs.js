...
var ReactCSSTransitionGroup = _interopDefault(
  ...
  createClass(CheckboxGroup, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        children = React__default.Children.map(children, function (
          child,
          index
        ) {
          if (!child) {
  ...
  createClass(Loading, [
    {
      ...
      value: function render() {
        ...
        return React__default.createElement(
          ...
          React__default.createElement(LoadingAddon, {
            type: type,
            show: show,
...
exports.AttentionLink = AttentionLink
exports.Badge = Badge
...
exports.InlineSelectOption = InlineSelectOption
exports.Input = Input
...
exports.LoadingAddon = LoadingAddon
