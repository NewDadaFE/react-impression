    ...
    getDate() {
        ...
        let firstDay = moment(currentMoment).date(1).day(),
            ...
            prevMonthMax = (firstDay - firstDayOfWeek) >= 0 ?
                (firstDay - firstDayOfWeek) : (firstDay - firstDayOfWeek + 7);
        ...
        let lastDay = moment(currentMoment).date(daysLength).day(),
            ...
            nextMonthMax = (lastDay - firstDayOfWeek) >= 0 ?
                (7 - lastDay + firstDayOfWeek) : (firstDayOfWeek - lastDay);
                            ...
                            <div
                                ...
                                <div
                                    className={classnames(
                                        ...
                                        {
                                            'text-secondary': (index + firstDayOfWeek) % 7 === 0
